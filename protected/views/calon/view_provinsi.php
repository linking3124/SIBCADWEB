...
<script type="text/javascript">
    ...
    function load() {
      ...
      //#429ADB biru
          ...
          var html = "<a target='_blank' href='../../kegiatanProvinsi/"+id_kegiatan +"'><b>" +" #" +id_kegiatan+ "</b></br><b>" + nama + "</b><br/><div align='left'>"+jenis+"</br>"+ tanggal+"<br/><img class='img-responsive-avatar-view' height='100' widh='100' src='<?php echo Yii::app()->request->baseUrl?>/images/kegiatan/"+foto+" '> </a></div>";
...
<h2><i class="fa fa-user"></i> Lihat Adkun Pengawas #<?php echo $model->id_calon; echo" "; echo $model->nama; ?></h2>
<div class="x_title">
                    </div>
                ...
                <div class="profile_img">
                            ...
                            <ul class="list-unstyled user_data">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th scope="row">Nama Akun Pengawas</th>
                      ...
                      <?php   
                              if ($kategori == '-1'){
                      ?>
                        <a title="Edit Data Akun Pengawas" class="btn btn-warning col-md-12" href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/calon/update/<?= $model->id_calon; ?>"><i class="fa fa-pencil"></i> Update <?= $model->username ?></a>
                        <a onclick="return confirm('Anda yakin ingin menghapus Akun Pengawas <?php echo $model->nama;?> ? Semua Kegiatan yang dilaporkan <?php echo $model->nama;?> juga ikut terhapus' )" title="Hapus BCAD" class="btn btn-danger col-md-12" href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/calon/delete/<?= $model->id_calon; ?>"><i class="fa fa-trash"></i> Hapus <?= $model->username?></a>
                        <?php } ?>
                        </div>
<br>
<br>
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                            <div class="panel-body">
                                                <table class="table">
                                                    <tbody>
                                                    <tr>
                                                        <th scope="row">ID Akun Pengawas</th>
...
<script src="Chart.bundle.js"></script>
    <div class="col-md-6">
    <h3><i class="fa fa-tasks"></i> Grafik Laporan Pengawas</h3>
                ...
                <?php foreach ($modelTabelProvinsi as $data) : ?>
                  ...
                  <tr>
                    ...
                    <!--<div class="hidden-sm hidden-xs action-buttons">-->
                      <a class="btn btn-success btn-xs" href="<?= Yii::app()->request->baseUrl; ?>/index.php/kegiatanProvinsi/<?= $data['id_kegiatan']; ?>" role="button"><i class="fa fa-search"></i></a>
