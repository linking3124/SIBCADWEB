...
<p class="note">Form dengan tanda <span class="required">*</span> wajib diisi.</p>
	<div class="form-group">
    	...
    	<div class="col-sm-9">
    	  <?php echo $form->textField($model,'username',array('title'=>'Setelah akun berhasil dibuat, hanya pemilik akun yang dapat mengganti username','class'=>'form-control has-feedback-left','required'=>'required', 'placeholder'=>'contoh: john','size'=>30,'maxlength'=>30)); ?>
