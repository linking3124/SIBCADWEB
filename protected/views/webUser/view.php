...
<br><br>    
                ...
                <div class="profile_img">
                        ...
                        <a title="Edit Profil Administrator" class="btn btn-warning col-md-12" href="<?= Yii::app()->request->baseUrl ?>/index.php/webUser/update/<?= $model->id_web_user ?>">Update Administrator</a>
