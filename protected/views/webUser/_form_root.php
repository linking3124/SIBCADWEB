...
<p class="note">Form dengan tanda <span class="required">*</span> wajib diisi.</p>
	<div class="form-group">
    	...
    	<div class="col-sm-9">
    	  <?php echo $form->textField($model,'username',array('title'=>'Root tidak bisa mengganti username, pemilik akun yang dapat mengganti username','class'=>'form-control has-feedback-left','required'=>'required', 'placeholder'=>'contoh: john','size'=>30,'maxlength'=>30,'readonly'=>'readonly')); ?>
 ...
 <!--  <?php foreach ($modelIdKategori as $data) : {
  ...
  <a>Keterangan kategori admin: </a>
    <br><ul>
    <li><a><b>Root</b> adalah <b>super admin</b> yang memiliki <b>akses penuh</b> untuk mengelola seluruh data (tambah, edit dan hapus).</a></li>
    <li><a><b>Pejabat</b> adalah <b>admin</b> yang memiliki akses untuk <b>melihat</b> saja namun tidak bisa menambah, mengedit dan menghapus data yang ada.</a></li>
    </ul>
