...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-tasks"></i> Tambah Data Kampus <small><!-- different form elements --></small></h2>
...
<p class="note">Form dengan tanda <span class="required">*</span> wajib diisi.</p>
	...
	<div class="form-group">
		<label class="col-sm-3 controll-label no-padding-right" for="form-field-1">Nama Kampus *</label>
    <div class="col-sm-9">
		<?php echo $form->textField($model,'nama',array('class'=>'form-control has-feedback-left', 'placeholder'=>'contoh: Kampus 1','size'=>60,'maxlength'=>100)); ?>
