    ...
    function load() {
      ...
      downloadUrl("<?php echo Yii::app()->request->baseUrl;?>/index.php/hasil/dataLokasi", function(data) {
        ...
        var lng = markers[i].getAttribute("lng");
          ...
          var html = "<a target='blank' href='hasil/"+ id_hasil +"'><b>" +" #" + "</b><b>" + nama + "<br/>"+pemenang+"</b><div align='left'>"+"<br/>Suara Paslon #1 : "+jlhsuara_paslon1+ "</br>Suara Paslon #2 : "+jlhsuara_paslon2+"</br>Suara Paslon #3 : "+jlhsuara_paslon3+"</br>Suara Paslon #4 : "+jlhsuara_paslon4+"<br/></br>Pengirim : "+nama_pengirim+" <br/>" +waktu+"</a></div>";
...
<!-- 	<h1>Selamat datang di <i><?php echo CHtml::encode(Yii::app()->name); ?> </i><img src="<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/e-pemilu.png" alt="..." style='height:50px; width:50px;'></h1>
 -->
<h3><i class="fa fa-map"></i> Peta hasil suara <small> E-Pemilu </small></h3> 
  <div class="x_title">
