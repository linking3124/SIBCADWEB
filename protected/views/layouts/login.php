...
<body>
  ...
  <div class="demo">
    <div class="login">
      <div class=""></div>
      <h1 class=judul onClick="location='<?php echo Yii::app()->request->baseUrl; ?>/index.php/home'">POLSUB</h1>
      <div class="logo">
      <img onclick="window.open('<?= Yii::app()->request->baseUrl ?>/index.php','_self')" src="<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/e-pemilu.png" height="80">
      </div>
      <?php echo $content; ?>
