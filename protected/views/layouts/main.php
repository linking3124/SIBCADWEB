...
$model = WebUser::model()->findByPk($username);
 ...
 $notifCount = NotifikasiKegiatan::model()->getCount();
 $notifGetData = NotifikasiKegiatan::model()->getDataHasil();
 $notifGetDataKabkota = NotifikasiKegiatan::model()->getDataHasilKabkota();
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/home" class="site_title"><i class="fa fa-compass"></i> <span><?php echo CHtml::encode(Yii::app()->name); ?>A</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kegiatanKabkota/admin"><i class="fa fa-file-text"></i>Verifikasi Laporan</a>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/e-pemilu.png" alt=""><?php echo $username ?>
                ...
                <!-- <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu"> -->
                   ...
                   <?php // foreach ($notifGetData as $data) : ?>
                    ...
                    <!-- <li>
                      <a target="blank" onclick="window.open('<?php  //echo Yii::app()->request->baseUrl; ?>/index.php/kegiatan/<?php // echo $data['id_kegiatan'];  ?>')">             
                        <span class="image"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/kegiatan/<?php //echo $data['foto']; ?>" alt="Profile Image" /></span>
                        <span>
                          <span style="font-weight: bold"><?php //echo $data['nama'] ?></span>
                          <span class="pull-right" style="font-style: italic;"> -->
                            <?php
                              // $timestr = $data['tanggal'];
    ...
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/home" class="site_title"><i class="fa fa-compass"></i> <span>POLSUB</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  ?>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/calon/admin"><i class="fa fa-user"></i>Kelola Akun</a></li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kegiatanKabkota/admin"><i class="fa fa-file-text"></i>Kelola Laporan Office Boy</a>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kegiatanProvinsi/admin"><i class="fa fa-file-text"></i>Kelola Laporan Pengawas</a>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kabkota/admin"><i class="fa fa-map-marker"></i> Kampus</a>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kec/admin"><i class="fa fa-map-marker"></i> Gedung</a>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/keldesa/admin"><i class="fa fa-map-marker"></i> Ruangan</a>
...
<!-- page content -->
        ...
        <!-- footer content -->
        <footer>
          <div class="pull-right"><img src="<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/e-pemilu.png" alt="..." style='height:40px; width:40px;'> © POLSUB 2023</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/custom/vendors/Chart.js/dist/Chart.bundle.js"></script>
    <!-- gauge.js -->
