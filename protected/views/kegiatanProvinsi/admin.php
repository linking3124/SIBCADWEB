...
<script type="text/javascript">
    ...
    function load() {
      ...
      downloadUrl("<?php echo Yii::app()->request->baseUrl;?>/index.php/kegiatanProvinsi/datalokasiAll", function(data) {
...
<script src="Chart.bundle.js"></script>
    ...
    <!-- Start Chart -->
    <div class="col-md-6">
    <h3><i class="fa fa-tasks"></i> Kelola Laporan Pengawas</h3>
...
<div class="clearfix"></div>
		<div class="col-md-6">
          <h3><i class="fa fa-tasks"></i> Peta Laporan Pengawas</h3>
        </div>
        <br>
        <br>
        <br>
...
<!-- TABLE STRIPED -->
			<!-- <div class="panel"> -->
				<div class="">
					<div class="col-md-6">
					<h3><i class="fa fa-tasks"></i> Tabel Laporan Pengawas</h3>
				</div>
                ...
                <th>Jumlah orang</th>
							...
							<tbody>
								...
								<?php foreach ($model as $data) : ?>
									...
									<tr>
										<td><?php echo $no;?></td>
										<td><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/calon/viewProvinsi/<?php echo $data['id_calon']; ?>"><?= $data['nama_calon']; ?></a></td>
