...
class KegiatanProvinsiController extends Controller
{
	/**
...
//			'postOnly + delete', // we only allow deletion via POST request
	...
	//	NotifikasiKegiatan::model()->klikNotif($id);
		$modelPemilik = KegiatanProvinsi::model()->getPemilikKegiatan($id);
	...
	{
		$model=new KegiatanProvinsi;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['KegiatanProvinsi']))
		{
			$model->attributes=$_POST['KegiatanProvinsi'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('KegiatanProvinsi');
	...
	{
		$db=new KegiatanProvinsi('search');
		$db->unsetAttributes();  // clear any default values
		if(isset($_GET['KegiatanProvinsi']))
			$db->attributes=$_GET['KegiatanProvinsi'];

		$model = KegiatanProvinsi::model()->getAll();
		$getAllCountPerJenis = KegiatanProvinsi::model()->getAllCountPerJenis();
	 ...
	 * @return KegiatanProvinsi the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=KegiatanProvinsi::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param KegiatanProvinsi $model the model to be validated
	 */
	...
	public function actionDataLokasi($id)
	{
		...
		$this->layout='mainxml';
			 ...
			 function parseToXML($htmlStr)
			 {
				...
				$model = KegiatanProvinsi::model()->getById($id);
