...
//			'postOnly + delete', // we only allow deletion via POST request
	...
	public function accessRules()
	{
		...
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('create','update','delete', 'datalokasi'),
				'users'=>array('@'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['WebUser']))
		{
			...
			if($model->save())
				Yii::app()->user->setFlash('success', "Administrator baru berhasil ditambahkan! Setelah akun berhasil dibuat, hanya pemilik akun yang dapat mengganti username");
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['WebUser']))
		{
			...
			$model->password=$model->hashPassword($_POST['WebUser']['password'],$acak);
			if($model->save())
				Yii::app()->user->setFlash('success', "Profil berhasi diperbarui!");
				$this->redirect(array('view','id'=>$model->id_web_user));
				//$this->redirect(Yii::app()->request->baseUrl. '/index.php/home');
