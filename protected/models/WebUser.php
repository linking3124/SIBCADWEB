...
class WebUser extends CActiveRecord
{
	...
	function getAllData() {
    $sql = "SELECT tb_web_user.id_web_user, tb_web_user.id_kategori, tb_web_user.username, tb_web_user.password, tb_web_user.nama_lengkap, tb_web_user.no_identitas, tb_web_user.email, tb_kategori.id_kategori, tb_kategori.keterangan FROM tb_web_user INNER JOIN tb_kategori WHERE tb_web_user.id_kategori = tb_kategori.id_kategori AND tb_web_user.username != 'root' ORDER BY tb_web_user.id_web_user ASC";
